...
const char *tproxy_map_path = "/run/zfw/zt_tproxy_map";
const char *tproxy6_map_path = "/run/zfw/zt_tproxy6_map";
const char *count_map_path = "/run/zfw/tuple_count_map";
const char *count6_map_path = "/run/zfw/tuple6_count_map";
const char *diag_map_path = "/run/zfw/diag_map";
const char *if_map_path = "/run/zfw/ifindex_ip_map";
const char *if6_map_path = "/run/zfw/ifindex_ip6_map";
const char *matched6_map_path ="/run/zfw/matched6_map";
const char *matched_map_path = "/run/zfw/maps/tc//globals/matched_map";
const char *egress_matched6_map_path ="/run/zfw/egress_matched6_map";
const char *egress_matched_map_path = "/run/zfw/maps/tc//globals/egress_matched_map";
const char *tcp_map_path = "/run/zfw/tcp_map";
const char *tcp_ingress_map_path = "/run/zfw/tcp_ingress_map";
const char *udp_map_path = "/run/zfw/udp_map";
const char *udp_ingress_map_path = "/run/zfw/udp_ingress_map";
const char *tun_map_path = "/run/zfw/tun_map";
const char *if_tun_map_path = "/run/zfw/ifindex_tun_map";
const char *transp_map_path = "/run/zfw/zet_transp_map";
const char *rb_map_path = "/run/zfw/rb_map";
const char *ddos_saddr_map_path = "/run/zfw/ddos_saddr_map";
const char *ddos_dport_map_path = "/run/zfw/ddos_dport_map";
const char *syn_count_map_path = "/run/zfw/syn_count_map";
const char *tp_ext_map_path = "/run/zfw/tproxy_extension_map";
const char *if_list_ext_map_path = "/run/zfw/if_list_extension_map";
const char *wildcard_port_map_path = "/run/zfw/wildcard_port_map";
const char *range_map_path = "/run/zfw/range_map";
const char *egress_range_map_path = "/run/zfw/egress_range_map";
const char *egress_if_list_ext_map_path = "/run/zfw/egress_if_list_extension_map";
const char *egress_ext_map_path = "/run/zfw/egress_extension_map";
const char *egress_map_path = "/run/zfw/zt_egress_map";
const char *egress6_map_path = "/run/zfw/zt_egress6_map";
